  ...
  return (
    ...
    <div className="App box-content h-auto w-auto bg-gradient-to-r from-violet-500 to-fuchsia-500">
        ...
        <div className="head flex flex-col justify-center items-center">
          ...
          <h1 className="text-center text-[55px] font-bold text-white">AWS KIIT Chapter Registration Page</h1>
          </div>
        
        <br />
        <form className="form_main box-content h-auto w-auto mx-[20%]">
        <div className="reg ">
          ...
          <button type="submit " className=" bg-pink-700 text-white font-bold px-[2%] py-[1%] rounded hover:bg-green-600">Register</button>
          <br />
          <div />
        </div>
      </form>
